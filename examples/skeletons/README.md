...
They intentionally rely on frridge's built-in router defaults, including
`frridge-frr:latest`, `privileged: true`, and the forwarding-oriented sysctls
used by the rest of the repository's FRR labs.
