...
This example enables IS-IS TI-LFA on a four-router SR-MPLS diamond and keeps explicit SR policies in place so primary and repair paths can be inspected from the same topology.
